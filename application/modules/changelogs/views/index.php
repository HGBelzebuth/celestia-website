<link rel="stylesheet" href="<?= base_url('assets/css/changelogs.css?v='.time()); ?>">
        ...
        <div class="uk-grid uk-grid-medium" data-uk-grid>
          <div class="uk-width-1-4@m">
            <ul class="uk-nav uk-nav-default myaccount-nav">
              ...
              <li class="uk-active"><a href="<?= base_url('changelogs'); ?>" style="font-size:16px"><i class="fas fa-scroll"></i> <?=$this->lang->line('tab_changelogs'); ?></a></li>
              <?php endif; ?>
          ...
          <div class="uk-width-3-4@m">
                  ...
                  <div class="uk-card-header">
                    <div class="uk-grid uk-grid-small" data-uk-grid>
                      ...
                      <div class="uk-width-auto@s">
                        <p class="uk-text-small" style="font-size:16px"><i class="far fa-clock"></i> <?= date('F j, Y, h:i a', $changelogsList->date); ?></p>
                      </div>
                    </div>
                  </div>
            ...
            <div class="uk-alert-warning" uk-alert>
              <p class="uk-text-center" style="font-size:16px"><i class="fas fa-exclamation-triangle"></i> <?= $this->lang->line('alert_changelog_not_found'); ?></p>
            </div>
            <?php endif; ?>
          </div>
        </div>
