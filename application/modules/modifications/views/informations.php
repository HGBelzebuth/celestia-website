<?php
/**
 * modifications/views/informations.php
 * CSS : assets/css/modifications_informations.css
...
<link rel="stylesheet" href="<?= base_url('assets/css/modifications_informations.css?v='.time()) ?>">
...
<div class="pn-raid-hero">
    ...
    <div class="pn-raid-hero-content cw-wrap">
        <div class="pn-raid-hero-medallion"><i class="fas fa-info-circle"></i></div>
        ...
        <h1 class="pn-raid-title"><span>Informations</span></h1>
        <div class="pn-raid-subtitle">Informations générales et paramètres du serveur Celestia-WoW</div>
        ...
        <div class="pn-sidebar-nav-wrap">
            <div class="pn-sidebar-nav">
                <?php if (!empty($sections)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="pn-no-changes-sidebar"><i class="fas fa-info-circle"></i> Aucune information</div>
                <?php endif; ?>
            </div>
    ...
    <div class="pn-content">
        <?php if (empty($sections)): ?>
            <div class="pn-vanilla-notice">
                ...
                <p>Aucune information n'a encore été renseignée.<br>Revenez bientôt.</p>
            </div>
        <?php else: ?>
            <?php foreach ($sections as $i => $section): ?>
