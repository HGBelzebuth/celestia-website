...
<div class="Pane Pane--underSiteNav Pane--cropFull" data-url="<?= $template['assets'].'core/css/images/background_teldrassil_01.png'; ?>" media-medium="!hide" queryselectoralways="0 31" media-original="Pane Pane--underSiteNav Pane--cropFull hide">
<div class="Pane-bg" style="background-color:#041828;background-image:url(&quot;<?= $template['assets'].'core/css/images/background_teldrassil_01.png'; ?>&quot;);">
          ...
          <div class="uk-width-3-4@m">
                ...
                <div class="uk-card-body">
                  <?= form_open(base_url($lang.'/changeusername')); ?>
                    <div class="uk-margin uk-light">
                      <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('panel_current_username'); ?>: </label>
                    ...
                    <div class="uk-margin uk-light">
                      <div class="uk-grid uk-grid-small" data-uk-grid>
                        <div class="uk-inline uk-width-1-2@s">
                          <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('placeholder_new_username'); ?>:</label>
                          <div class="uk-form-controls">
                            <div class="uk-inline uk-width-1-1">
                        ...
                        <div class="uk-inline uk-width-1-2@s">
                          <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('placeholder_confirm_username'); ?>:</label>
                          <div class="uk-form-controls">
                            <div class="uk-inline uk-width-1-1">
                              <span class="uk-form-icon"><i class="far fa-user fa-lg"></i> </span>
            ...
            <div class="uk-card-default myaccount-card uk-margin-small">
              ...
              <div class="uk-card-body">
                ...
                <div class="uk-margin uk-light">
                  <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('panel_current_email'); ?>:</label>
                  <div class="uk-form-controls">
                    <div class="uk-inline uk-width-1-1">
                ...
                <div class="uk-margin uk-light">
                  <div class="uk-grid uk-grid-small" data-uk-grid>
                    <div class="uk-inline uk-width-1-2@s">
                      <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('panel_replace_email_by'); ?></label>
                      <div class="uk-form-controls">
                        <div class="uk-inline uk-width-1-1">
                    ...
                    <div class="uk-inline uk-width-1-2@s">
                      <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('placeholder_confirm_email'); ?></label>
                      <div class="uk-form-controls">
                        <div class="uk-inline uk-width-1-1">
                          <span class="uk-form-icon"><i class="far fa-envelope fa-lg"></i></span>
            ...
            <div class="uk-card-default myaccount-card uk-margin-small">
              ...
              <div class="uk-card-body">
                ...
                <div class="uk-margin uk-light">
                  <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('placeholder_current_password'); ?>:</label>
                  <div class="uk-form-controls">
                    <div class="uk-inline uk-width-1-1">
                      <span class="uk-form-icon"><i class="fas fa-key fa-lg"></i></span>
                ...
                <div class="uk-margin uk-light">
                  <div class="uk-grid uk-grid-small" data-uk-grid>
                    <div class="uk-inline uk-width-1-2@s">
                      <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('panel_replace_pass_by'); ?></label>
                      <div class="uk-form-controls">
                        <div class="uk-inline uk-width-1-1">
                    ...
                    <div class="uk-inline uk-width-1-2@s">
                      <label class="uk-form-label" style="font-size:16px"><?= $this->lang->line('placeholder_re_password'); ?></label>
                      <div class="uk-form-controls">
                        <div class="uk-inline uk-width-1-1">
